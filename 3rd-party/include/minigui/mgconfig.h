...
#define MINIGUI_MAJOR_VERSION 4
...
#define PACKAGE_STRING "libminigui 4.0.0"
...
#define _MGCHARSET_UNICODE_FULL 1

/* Define if support complex scripts based on HarfBuzz */
/* #undef _MGCOMPLEX_SCRIPTS */
