#ifndef ACCESS_TOKEN_ACTIVITY_HH
#define ACCESS_TOKEN_ACTIVITY_HH

#include "macros.h"
#include "DialpadStatusActivity.h"

class AccessTokenActivity : public DialpadStatusActivity
{
// 1. public members
public:
    // 1.1. typedefs
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(AccessTokenActivity);
